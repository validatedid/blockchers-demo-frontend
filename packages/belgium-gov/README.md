...
```sh
docker build --build-arg PUBLIC_URL=https://app.ebsi.tech.ec.europa.eu/diploma/belgium-gov --build-arg REACT_APP_WALLET_API=https://api.ebsi.tech.ec.europa.eu/wallet -t ebsi:1-diploma-front-end-belgium-gov .
```
