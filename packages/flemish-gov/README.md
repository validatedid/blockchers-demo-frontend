...
```sh
docker build --build-arg PUBLIC_URL=https://app.ebsi.tech.ec.europa.eu/diploma/flemish-gov --build-arg REACT_APP_WALLET_URL=https://api.ebsi.tech.ec.europa.eu/wallet -t ebsi:1-demo-front-ends-flemish-gov .
```
