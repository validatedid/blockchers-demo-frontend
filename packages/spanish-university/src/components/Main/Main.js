...
class Main extends Component {
  ...
  presentIDToTheWallet(connection_id, did) {
    return new Promise(function(resolve, reject) {
      axios
        .get(
          API_URL + "/present-verifiable-id-proof/" + connection_id + "/" + did
        )
        .then(res => {
          resolve(res.data);
        })
  ...
  presentCredential() {
    ...
    this.presentCredentialToTheWallet(connection_id, did, credentialType).then(
      res => {
        ...
        <header className="App-header">
          ...
          >
            ...
            <Toast.Body className="blocktext">
              The id verification was successfully, you can now present your
              Diploma
            </Toast.Body>
          </Toast>

          <Toast
            show={successToastToEnroll}
            onClose={() => this.handleClose()}
            style={{
              position: "absolute",
              left: 0,
          ...
          >
            ...
            <Toast.Body className="blocktext">
              The credential verification was successfully, you can now enroll
              to the program
            </Toast.Body>
          </Toast>

          <img src={logo} className="App-logo" alt="logo" />
          <p className="blocktext">University Rovira i Virgili</p>
          <ButtonGroup size="lg">
            <Button
            ...
            <Button
              className="view-button"
              variant="success"
              onClick={() => this.presentCredential()}
              disabled={credential}
            >
              Present Diploma
            </Button>
