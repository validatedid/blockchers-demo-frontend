...
class Main extends Component {
    ...
    presentIDToTheWallet(connection_id, did){
        return new Promise(function (resolve, reject) {
            axios.get(API_URL + '/present-verifiable-id-proof/'+connection_id+'/did'+did)
            .then(res => {
                resolve(res.data);
            })
            .catch(function (error) {
            ...
            <div className="App">
                <header className="App-header">
                    ...
                    <Toast show={successToast} 
                        ...
                        <Toast.Body className="blocktext">The id verification was successfully, you can now ask for you credential</Toast.Body>
                    </Toast>
                    ...
                    <ButtonGroup size="lg">
                        ...
                        <Button className="view-button" variant="success" onClick={() => this.requestCredential()} disabled={credential}>
                            Request Credential
                        </Button>
                    </ButtonGroup>
